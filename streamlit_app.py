...
def vasama_dashboard():
    ...
    st.markdown("[Vasama](https://github.com/TomiToivio/vasama) OSINT demo dashboard.", unsafe_allow_html=True)
    ...
    if selection.empty:
        ...
        with tab6:
            ...
            st.markdown("""* Data Collection: Data collection with custom web scrapers and official APIs.""", unsafe_allow_html=True)
            st.markdown("""* Data Storage: Storage of metadata and media files.""", unsafe_allow_html=True)
            st.markdown("""* Data Analysis: Customizable data analysis pipeline with multimodal LLMs and other data analysis tools.""", unsafe_allow_html=True)
            st.markdown("""* Data Visualization: [Streamlit dashboard](https://vasama.streamlit.app/) of data analysis results.""", unsafe_allow_html=True)
